    ...
    return (
        <div className='flex flex-col gap-5 mt-8 w-full'>
            ...
            <div className=' flex flex-row justify-center items-center'>
                <button className='w-[20%] dark:bg-gradient-to-tr  dark:from-[#FF6A00] dark:via-[#10152E] dark:to-[#F81969] p-[1px] rounded-2xl'><div className='bg-white dark:bg-black hover:dark:bg-red-950  rounded-2xl px-6 p-3 w-full'>Apply</div></button>
            </div>
        </div>
    );
}
