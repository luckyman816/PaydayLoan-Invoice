      ...
      <div className="w-full dark:bg-gradient-to-tr dark:from-[#FF6A00] dark:via-[#10152E] dark:to-[#F81969] p-[1px] rounded-2xl md:w-[470px] ">
        <div className="bg-white dark:bg-black rounded-2xl p-6 w-full h-full">
          ...
          <ul className="text-white text-lg mt-7">
            <div
              onClick={() => setPage(1)}
              className={`mt-2 border-none p-[1px] border-[#DCE4EF] flex items-center  text-black dark:text-white dark:border-black my-1 dark:hover:bg-gradient-to-tr to-[#295e55] via-[#3c54cf] hover:scale-[1.05] hover:transition duration-100 rounded-xl cursor-pointer text-lg ${ page === 1 && "dark:bg-[#10152E] border-none bg-gradient-to-tr to-[#295e55] via-[#3c54cf] rounded-xl" }`}
              >
            ...
            <div
              onClick={() => setPage(2)}
              className={`mt-2 border-none p-[1px] border-[#DCE4EF] flex items-center  text-black dark:text-white dark:border-black my-1 dark:hover:bg-gradient-to-tr to-[#295e55] via-[#3c54cf] hover:scale-[1.05] hover:transition duration-100 rounded-xl cursor-pointer text-lg ${ page === 2 && "dark:bg-[#10152E] border-none bg-gradient-to-tr to-[#295e55] via-[#3c54cf] rounded-xl" }`}
              >
              <div className="bg-white border-none dark:bg-black opacity-90 rounded-xl w-full h-full p-2">
                Application
              </div>
