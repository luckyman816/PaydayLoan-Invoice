        ...
        <div id="dashModalContent" className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0 z-50">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button type="button" onClick={()=>handleFunc(1)} className="inline-flex justify-center rounded-md bg-green-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto  min-w-20 ">Accept</button>
              <button type="button" onClick={()=>handleFunc(0)} className="inline-flex justify-center rounded-md bg-gray-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-500 sm:ml-3 sm:w-auto min-w-20">Pending</button>
              <button type="button" onClick={()=>handleFunc(2)} className="inline-flex justify-center rounded-md bg-red-700 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto min-w-20">Reject</button>
            </div>
          </div>
        </div>
      </div>
